...
public class TestarInterfaceDisciplina {
	...
	public void setUp() {
	    ...
	    window = new FrameFixture(new VDisciplina());
	...
	public void testarCadastroCerto()
	{
		...
		try
		{
			...
			window.textBox("Nome").enterText("Sociologia");
	...
	public void testarAlterarDado()
	{
			...
			window.textBox("Nome").enterText("Astronomia");
			window.button("Cadastrar").click();
